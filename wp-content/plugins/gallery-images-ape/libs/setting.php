...
?>
	<br/>
	<p  class="description">
		here you can configure settings for default gallery usage.
		<br/>
		Just select which Ape gallery will provide settings source for default WordPress gallery which gonna be published on your website
	</p>
	<table class="form-table">
		<tr>
			<th scope="row">
