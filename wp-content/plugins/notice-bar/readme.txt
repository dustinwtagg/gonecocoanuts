...
Donate link: http://wensolutions.com/plugins/
Tags: notice, bar, floating bar, message, notication, sticky header, notification bar, announcement, alert, offer bar, news ticker notice bar, slider notice bar, sticky social icons, 
...
= Some Useful Links = 
- [Demo](http://wensolutions.com/notice-bar-demo/)
- [Documentation](http://wensolutions.com/documentation/notice-bar/)
- [Support Forum](http://themepalace.com/forum/notice-bar/)

**More Pro Features**

Notice Bar Pro: [Detail](http://themepalace.com/downloads/notice-bar-pro/) | [Demo](http://wensolutions.com/notice-bar-pro-demo/)
...
3. Select `notice-bar.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

= Using FTP =

1. Download `notice-bar.zip`
...
Nice, make a post on the [Support Forum](http://themepalace.com/forum/notice-bar/ "Notice Bar Support") and let us know. We are always looking for ways to improve our plugins.


== Screenshots ==

1. Plugin Settings
2. Plain Text Notice Bar
3. Slider Notice Bar
4. News Ticker Notice Bar
5. Social Icons Notice Bar

== Changelog ==

= 2.0.5 =
* Font size option has been removed. 
* POT file added.
