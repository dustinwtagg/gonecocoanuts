...
<div class="wpfm-display-setting-wrapper">
    ...
    <div class="wpfm-setting-body">
        ...
        <div class="layout-7-hidden-field" id="wpfm-nav-icon-hover-transform-wrap"
        <?php if (isset($template_design_settings['custom_template']['menu_layout']) && ($template_design_settings['custom_template']['menu_layout'] == 'template-7')) {
            ?>style="display:block;"<?php } else { ?>style="display:none;"<?php } ?>>
            <div class="wpfm-menu-display-setting" id="wpfm-bg-color-wrap">
